...
@Slf4j
@Configuration
@MapperScan(basePackages = "com.ler.mina.dao", sqlSessionTemplateRef = "sqlSessionTemplate")
public class MybatisConfig {

    private static final String BASE_PACKAGE = "com.ler.mina.";
    ...
    public DataSource dataSource() {
        DBVO db = JSONObject.parseObject(dbVO, DBVO.class);
        try {
            DruidDataSource dataSource = new DruidDataSource();
            dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
            dataSource.setUrl(db.getDbUrl());
